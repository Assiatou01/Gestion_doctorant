...
<head>
    ...
    <style>
        ...
        .info-label { font-weight: bold; color: #0d6efd; text-transform: uppercase; font-size: 0.75rem; letter-spacing: 1px; }
        .info-value { color: #212529; font-size: 1.05rem; margin-bottom: 15px; }
        .card-custom { border: none; border-radius: 1rem; box-shadow: 0 0.5rem 1rem rgba(0,0,0,0.05); transition: transform 0.2s; }
        .card-custom:hover { transform: translateY(-3px); }
        .stat-badge { font-size: 1.1rem; padding: 8px 20px; border-radius: 50px; background-color: rgba(255,255,255,0.2); backdrop-filter: blur(4px); }
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row text-center">
                        <div class="col-6 border-end">
                            ...
                            <div class="info-value text-success fw-bold"><fmt:formatDate value="${doctorant.dateStart}" pattern="dd MMMM yyyy" /></div>
                        </div>
                        <div class="col-6">
                            <div class="info-label">Fin de Thèse (Prévision)</div>
                            <div class="info-value text-danger fw-bold"><fmt:formatDate value="${doctorant.dateEnd}" pattern="dd MMMM yyyy" /></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-4">
            ...
            <div class="card card-custom">
                <div class="card-body p-4 text-center">
                    ...
                    <div class="mt-3">
                        <a href="/doctorant/modifier/${doctorant.id}" class="btn btn-warning rounded-pill w-100"><i class="fas fa-edit me-2"></i>Éditer le profil</a>
                    </div>
                </div>
            </div>
        </div>
