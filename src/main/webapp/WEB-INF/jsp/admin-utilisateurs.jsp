                    ...
                    <c:forEach items="${utilisateurs}" var="u">
                        <c:if test="${u.id != null}">
                            <tr>
                                ...
                                <td><span class="badge bg-secondary rounded-pill">${u.role}</span></td>
                                <td>
                                ...
                                <td class="text-center">
                                    <a href="/admin/utilisateur/supprimer/${u.id}" class="btn btn-sm btn-danger btn-table" onclick="return confirm('Supprimer cet utilisateur ?')"><i class="fas fa-trash"></i> Supprimer</a>
                                </td>
                            </tr>
                        </c:if>
                    </c:forEach>
